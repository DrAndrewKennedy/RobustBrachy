...
from robustbrachy.robustevaluation.run_robust_evaluation_gpu import *
...
no_of_runs = 500  # 500 or 1000 has low statistical uncertainty
...
) = run_robust_evaluation_program_gpu(
    file_rp,
    file_rs,
    file_rd,
    file_source_data,
