...
def TG43calc_dose_per_dwell_per_vol_pt_cpu(
    dose_calc_pts,
    dwell_times,
    plan_parameters,
    dwell_coords,
    ...
    active_dwell_times_mask = (dwell_times > 0).astype(np.bool_)
    ...
    dose_per_dwell_per_vol_pt = np.einsum(
...
__all__ = ["TG43calc_dose_per_dwell_per_vol_pt_cpu"]
