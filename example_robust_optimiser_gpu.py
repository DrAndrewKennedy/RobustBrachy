...
from robustbrachy.robustoptimisation.run_robust_optimiser_gpu import *
...
) = run_robust_optimiser_program_gpu(
    file_rp,
    file_rs,
    file_rd,
    file_source_data,
